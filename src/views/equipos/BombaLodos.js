...
import bombaDeLodosImage from "assets/img/bombaDeColas.jpeg";
    ...
    <>
      ...
      <div className="chancadora-container">
        ...
        <div className="image-container">
          <img src={bombaDeLodosImage} alt="Bomba de Lodos" />
          ...
          <div className="hover-item" style={{ top: '30%', left: '20%' }} onClick={() => handleTabClick('info')}>
            ...
            <div className="hover-text">
              <h4>Información</h4>
              <p>La bomba de lodos se utiliza para transportar mezclas de sólidos y líquidos en el procesamiento de minerales.</p>
            </div>
          </div>
        ...
        <div className="additional-text">
          <h3>Información</h3>
          <p>
            La planta piloto de procesamiento de minerales de TECSUP cuenta con bombas de lodos que son esenciales para el transporte eficiente de mezclas de sólidos y líquidos en el proceso. Estas bombas son cruciales para mantener un flujo continuo de materiales entre diferentes etapas del procesamiento.
          </p>
          <h4>Capacidad de la Bomba de Lodos</h4>
          <p>
            La bomba de lodos instalada en la planta piloto tiene una capacidad nominal de 1000 litros por hora, permitiendo un manejo eficiente de grandes volúmenes de lodo.
          </p>
