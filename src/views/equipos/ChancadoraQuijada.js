...
import chancadoraImage from "assets/img/quijada.jpg";
    ...
    <>
      ...
      <div className="chancadora-container">
        ...
        <div className="image-container">
          <img src={chancadoraImage} alt="Chancadora" />
          ...
          <div className="hover-item" style={{ top: '30%', left: '20%' }} onClick={() => handleTabClick('info')}>
            ...
            <div className="hover-text">
              <h4>Información</h4>
              <p>La chancadora de quijada es un equipo de trituración de minerales que utiliza una mandíbula móvil y una fija para romper el material.</p>
            </div>
          </div>
        ...
        <div className="additional-text">
            <h3>Información</h3>
            <p>
              La planta piloto de procesamiento de minerales de TECSUP cuenta con una chancadora de quijada, también conocida como trituradora de mandíbulas, que es fundamental en la etapa de trituración primaria del mineral. Esta chancadora se encarga de reducir el tamaño de las partículas del mineral, facilitando así su posterior procesamiento en las siguientes etapas.
            </p>
            <h4>Capacidad de la Chancadora de Quijada</h4>
            <p>
              La chancadora de quijada instalada en la planta piloto tiene una capacidad nominal de 50 kg/h. Sin embargo, debido a limitaciones en la capacidad de la zaranda y las fajas transportadoras, la alimentación real de la chancadora se ha restringido a 20 kg/h. Este ajuste asegura que el sistema opere de manera eficiente sin sobrecargar los componentes subsiguientes.
            </p>
            <h4>Consideraciones Operativas</h4>
            <ul>
              <li>Se debe monitorizar constantemente la tasa de alimentación desde la tolva, asegurando que no exceda los 20 kg/h.</li>
